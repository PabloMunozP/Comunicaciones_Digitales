...
salida=open("COD_JPG/COD_JPG.txt","w")
for i in range (1,31):
    
    im = Image.open( "Imagenes/" + str(i) + ".png")
    tam_org=os.path.getsize("Imagenes/" + str(i) + ".png")
    im.convert('RGB').save("COD_JPG/" + str(i) + '_jpg.jpg', quality = 50)
    tam_comp=os.path.getsize("COD_JPG/" + str(i) + '_jpg.jpg')
...
entropia=0
for i in range (1,31):
    img2 = Image.open ("COD_JPG/" + str(i) + '_jpg.jpg')
